...
class ForecastingParameters:
    ...
    DEFAULT_TIMESERIES_VALUE = {
        ...
        TimeSeries.ENABLE_FUTURE_REGRESSORS: TimeSeriesInternal.FUTURE_REGRESSORS_DEFAULT,
        TimeSeries.FEATURES_UNKNOWN_AT_FORECAST_TIME: TimeSeriesInternal.FEATURES_UNKNOWN_AT_FORECAST_TIME_DEFAULT
    }
    ...
    def __init__(
            ...
            TimeSeriesInternal.FEATURES_UNKNOWN_AT_FORECAST_TIME_DEFAULT,
            validate_parameters: bool = True,
            _enable_future_regressors: bool = False,
            **kwargs: Any
    ):
        ...
        self._features_unknown_at_forecast_time = features_unknown_at_forecast_time
        ...
        self._formatted_unknown_features = None  # type: Optional[List[str]]
        ...
        self._enable_future_regressors = _enable_future_regressors  # private flag for enabling future regressors.
    ...
    def validate_parameters(self):
        ...
        self._validate_future_regressor_handling(self._enable_future_regressors)
        self._validate_features_unknown_at_forecast_time()
    ...
    @property
    def formatted_unknown_features(self) -> Optional[List[str]]:
        """
        The column name(s) of features that are available for training but unknown at forecast/inference time.
        If this is not defined, it is assumed that all the feature columns are known at forecast time.
        Only supported in dnn/tcn.
        When user not specifying anything, future features are not enabled in dnn. However, if they provide
        an empty list, future features are enabled, and all feature columns are assumed to be known at forecast
        time.
        """
        if self._formatted_unknown_features is None:
            if self.features_unknown_at_forecast_time == []:
                self._formatted_unknown_features = []
            else:
                self._formatted_unknown_features = self._make_column_names_list(
                    self.features_unknown_at_forecast_time, use_empty_list=False)
        return self._formatted_unknown_features

    @property
    def features_unknown_at_forecast_time(self) -> Union[str, List[str], None]:
        """
        The column name(s) of features that are available for training but unknown at forecast/inference time.
        If this is not defined, it is assumed that all the feature columns are known at forecast time.
        """
        return self._features_unknown_at_forecast_time

    @features_unknown_at_forecast_time.setter
    def features_unknown_at_forecast_time(self,
                                          features_unknown_at_forecast_time: Union[str, List[str], None]) -> None:
        self._features_unknown_at_forecast_time = features_unknown_at_forecast_time
        self._formatted_unknown_features = None
        self._validate_features_unknown_at_forecast_time()
        ...
        if not isinstance(col_name, str):
            raise ConfigException._with_error(
                AzureMLError.create(
                    ...
                    target=target, argument=target + " ({})".format(str(col_name)),
    ...
    def _validate_future_regressor_handling(self, val: Any) -> None:
        """
        Validate the type of enable_future_regressors.
        ...
        if not isinstance(val, bool):
            raise ConfigException._with_error(
                AzureMLError.create(
                    InvalidArgumentType, target=TimeSeries.ENABLE_FUTURE_REGRESSORS,
                    argument=TimeSeries.ENABLE_FUTURE_REGRESSORS,
                    actual_type=type(val),
                    expected_types='bool',
                    reference_code=ReferenceCodes._FORECASTING_PARAM_ENABLE_FUTURE_REGRESSORS_INVALID_TYPE)
            )

    def _validate_features_unknown_at_forecast_time(self) -> None:
        unknown_features = self._features_unknown_at_forecast_time
        expected_types = ', '.join(["str", "List[str]", "None"])
        if isinstance(unknown_features, list):
            for col in unknown_features:
                self._check_column_name_type(
                    col, TimeSeries.FEATURES_UNKNOWN_AT_FORECAST_TIME,
                    expected_types,
                    ReferenceCodes._FORECASTING_PARAM_FEATURES_UNKNOWN_AT_FORECAST_TIME_LIST_INVALID_TYPE)
        elif unknown_features is not None:
            self._check_column_name_type(
                unknown_features, TimeSeries.FEATURES_UNKNOWN_AT_FORECAST_TIME,
                expected_types,
                ReferenceCodes._FORECASTING_PARAM_FEATURES_UNKNOWN_AT_FORECAST_TIME_INVALID_TYPE)
